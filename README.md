...
> [!WARNING]
> Archive.org still doesn't allow new files at this moment so for now all new files are stored on onedrive.
...
|-------|------------|--------|---------------|--------|---------|
|2.6 hotfix 2|Spacewar-U2.6-241031-1818||[EEA/GLOBAL from 2.6 hotfix](https://hogent-my.sharepoint.com/:u:/g/personal/quinten_vandamme_student_hogent_be/Ee6TzGtqAslJpqkFAvn3m8sBiShvmg8vApCmv4LoEA9lpA?e=FIiTlQ)||<details><summary>changelog</summary>What’s new in this update<br>General improvements and bug fixes<br>📞 Expanded support for video calling across more carriers.<br>📶 Fixed the issue where some devices couldn’t connect to VoLTE.<br>🛡️ Updated security patch to November.<br>🔄 Fixed system lag when rapidly switching the network tile in Quick Settings.<br>🎧 Resolved the issue of the Bluetooth tile not refreshing device status promptly.<br>📷 Fixed the issue where photos taken at 2.0x zoom or higher didn’t display detail information.</details>|
...
|Version|build number|Full OTA|Incremental OTA|Rollback|
|-------|------------|--------|---------------|--------|
|2.6 hotfix 2|Pong-U2.6-241016-1700||[All regions from 2.6 hotfix](https://hogent-my.sharepoint.com/:u:/g/personal/quinten_vandamme_student_hogent_be/Edi3QVO4UaJKhEt50Eb8TK0Bl0qhVLQHFhgWn7qWzg4ObA?e=2kAihC)||
